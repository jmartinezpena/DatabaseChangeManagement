namespace EmployeeDirectory.Infrastructure
{
    ...
    public static class HtmlHelperExtensions
    {
        ...
        {
            return html.SubmitButton("Save");
        }

        public static TagBuilder SubmitButton<TModel>(this IHtmlHelper<TModel> html, string text)
        {
        ...
        public static TagBuilder ConfigureButton<TModel>(this IHtmlHelper<TModel> html, string url)
        {
            var button = new TagBuilder("a");

            button.MergeAttribute("href", url);
            button.InnerHtml.AppendHtml(MaterialIcon("security"));
        ...
        private static TagBuilder MaterialIcon(string iconName)
        {
